				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ingresa el nombre del curso" required data-error="El nombre del curso es obligatorio" value="${curso.nombre}">
							<div class="help-block with-errors text-danger"></div>
						</div>                                 
					</div>
					<div class="col-md-12">
						<div class="form-group">
							<input type="text" class="form-control" id="precio" name="precio" placeholder="Ingresa el precio del curso" required data-error="El precio es obligatorio" value="${curso.precio}">
							<div class="help-block with-errors text-danger"></div>
						</div>                                 
					</div>
